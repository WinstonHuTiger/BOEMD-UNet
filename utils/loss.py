...
class SegmentationLosses(object):
    ...
    def ELBO(self, input, target, kl, beta, train_size):
        ...
        target: the corresponding ground truth
        kl: the kl divergence
        beta: the beta hyper-parameter
        train_size: the train size of the the current banch
        ...
        return self.dice_coef(input, target) * train_size + beta * kl
